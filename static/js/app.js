...
const Icon = {
  ...
  Thermometer: ({
    ...
    d: "M14 14.76V3.5a2.5 2.5 0 00-5 0v11.26a4 4 0 105 0z",
    stroke: color,
    strokeWidth: "1.5"
  })),
  Globe: ({
...
async function askStream(question, params, history, callbacks, controllerRef) {
  ...
  try {
    ...
    if (!resp.ok) {
      ...
      callbacks.onError(errBody.error || {
        code: 'INTERNAL_ERROR',
...
function groupConversations(convs) {
  ...
  for (const c of convs) {
    ...
    if (d >= today) groups.today.push(c);else if (d >= today - oneDay) groups.yesterday.push(c);else if (d >= today - 7 * oneDay) groups.week.push(c);else groups.earlier.push(c);
  }
  return groups;
}
...
function renderAnswer(answer, sources) {
  ...
  html = DOMPurify.sanitize(html, {
    ADD_ATTR: ['target', 'rel', 'data-index']
  });
...
function LeftSidebar({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(Icon.Logo, {
    size: 18
  })), /*#__PURE__*/React.createElement("span", {
    className: "sidebar-logo-text"
  }, "WebRAG"), /*#__PURE__*/React.createElement("button", {
    ...
    size: 16,
    color: "white"
  }), /*#__PURE__*/React.createElement("span", null, "新建对话")), /*#__PURE__*/React.createElement("div", {
    className: "conv-list"
  ...
  }, user ? '暂无对话记录' : '登录后开始提问') : Object.entries(groups).map(([key, items]) => {
    if (items.length === 0) return null;
    return /*#__PURE__*/React.createElement("div", {
      key: key
    }, /*#__PURE__*/React.createElement("div", {
      className: "conv-group-label"
    }, groupLabels[key]), items.map(conv => /*#__PURE__*/React.createElement("div", {
      key: conv.id,
    ...
    }, conv.title || '新对话')), /*#__PURE__*/React.createElement("button", {
    ...
    size: 18
  }), /*#__PURE__*/React.createElement("span", null, user ? user.username + (isAdmin ? '（管理员）' : '') : '账户'))));
}
...
function AuthModal({
  ...
  const submit = async () => {
    ...
    setSubmitting(true);
    try {
      if (mode === 'login') await onLogin(uname, password);else await onRegister(uname, password);
    } catch (e) {
  ...
  return /*#__PURE__*/React.createElement(Modal, {
  ...
  }, user.role === 'admin' ? '管理员' : '普通用户')), user.role === 'admin' && /*#__PURE__*/React.createElement("a", {
    href: "/admin/",
    className: "account-admin-link",
    onClick: onClose
  }, "进入后台管理 →"), /*#__PURE__*/React.createElement(Button, {
    type: "primary",
    danger: true,
    block: true,
    onClick: onLogout,
  ...
  }), mode === 'register' && /*#__PURE__*/React.createElement(Input.Password, {
    value: confirmPwd,
    ...
    loading: submitting,
    onClick: submit
  }, mode === 'login' ? '登 录' : '注 册'), /*#__PURE__*/React.createElement("p", {
...
function MessageBubble({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(Icon.Robot, {
    size: 16
  })), /*#__PURE__*/React.createElement("div", {
    className: "msg-content"
  }, isLoading && !msg.content ? /*#__PURE__*/React.createElement("div", {
    className: "msg-status"
  }, /*#__PURE__*/React.createElement("span", {
    className: "msg-status-dot"
  }), /*#__PURE__*/React.createElement("span", null, msg.statusText || '正在思考…')) : isError ? /*#__PURE__*/React.createElement("div", {
    className: "msg-bubble error"
  }, msg.content, onRetry && /*#__PURE__*/React.createElement("button", {
  ...
  }, "重试")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: 'msg-bubble ai' + (isLoading ? ' typing-cursor' : ''),
    dangerouslySetInnerHTML: {
      __html: html
    }
  }), !isLoading && msg.content && /*#__PURE__*/React.createElement("div", {
    className: "msg-meta"
  }, msg.cached && msg.cacheTime != null && /*#__PURE__*/React.createElement("span", {
    className: "meta-badge cached"
  }, "⚡ 命中缓存 · ", (msg.cacheTime / 1000).toFixed(1), "s"), !msg.cached && msg.searchTime != null && /*#__PURE__*/React.createElement("span", {
    className: "meta-badge search"
  }, "🌐 联网搜索 · ", (msg.searchTime / 1000).toFixed(1), "s"), !msg.cached && msg.genTime != null && /*#__PURE__*/React.createElement("span", {
    className: "meta-badge gen"
  }, "✍ 生成 · ", (msg.genTime / 1000).toFixed(1), "s"), msg.totalTime != null && /*#__PURE__*/React.createElement("span", {
    className: "meta-badge total"
  }, "⏱ 总计 · ", (msg.totalTime / 1000).toFixed(1), "s")), msg.sources && msg.sources.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "msg-sources"
  }, /*#__PURE__*/React.createElement("div", {
    className: "msg-sources-title"
  }, "参考来源"), /*#__PURE__*/React.createElement("div", {
    className: "msg-sources-list"
  }, msg.sources.map(src => /*#__PURE__*/React.createElement("a", {
    key: src.index,
    ...
    className: "source-card-num"
  }, src.index), /*#__PURE__*/React.createElement("span", {
    className: "source-card-title"
  }, src.title || src.url))))), !isLoading && msg.content && /*#__PURE__*/React.createElement("div", {
    className: "msg-feedback"
  }, /*#__PURE__*/React.createElement("span", {
    className: "fb-label"
  }, "回答有帮助吗？"), /*#__PURE__*/React.createElement("button", {
    className: 'fb-btn' + (msg.feedback === 'good' ? ' active' : ''),
    onClick: () => onFeedback(msgIndex, 'good'),
    title: "有用"
  }, /*#__PURE__*/React.createElement(Icon.ThumbsUp, {
    size: 15
  })), /*#__PURE__*/React.createElement("button", {
    className: 'fb-btn' + (msg.feedback === 'bad' ? ' active' : ''),
    onClick: () => onFeedback(msgIndex, 'bad'),
    title: "没用"
  }, /*#__PURE__*/React.createElement(Icon.ThumbsDown, {
    size: 15
  })), /*#__PURE__*/React.createElement("button", {
    className: "fb-btn",
    onClick: handleCopy,
...
function EmptyGuide({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "empty-guide-icon"
  }, /*#__PURE__*/React.createElement(Icon.Robot, {
    size: 28,
    color: PRIMARY
  })), /*#__PURE__*/React.createElement("div", {
    className: "empty-guide-title"
  }, "WebRAG 智能问答"), /*#__PURE__*/React.createElement("div", {
    className: "empty-guide-sub"
  }, "检索真实网页后生成回答 —— 每个 [n] 引用都可点击溯源。 默认检索本地知识库，开启联网搜索后可获取实时信息。"), /*#__PURE__*/React.createElement("div", {
    className: "empty-guide-examples"
  }, QUICK_EXAMPLES.map((ex, i) => /*#__PURE__*/React.createElement("button", {
    key: i,
...
function InputArea({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: 'input-mode-tag' + (useWebSearch ? ' online' : '')
  }, useWebSearch ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon.Globe, {
    size: 14
  }), " 联网搜索模式") : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Icon.Search, {
    size: 14
  }), " 本地知识库"))), /*#__PURE__*/React.createElement("div", {
  ...
  }, "回答由大模型基于检索到的网页内容生成，仅供参考，请以原始来源为准。")));
}
...
function RightSidebar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    size: 18
  }), " 生成参数"), /*#__PURE__*/React.createElement("button", {
    ...
    className: "param-module"
  }, /*#__PURE__*/React.createElement("div", {
    className: "param-module-header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "param-module-icon temp"
  }, /*#__PURE__*/React.createElement(Icon.Thermometer, {
    size: 16,
    color: "#FA8C16"
  })), /*#__PURE__*/React.createElement("span", {
    className: "param-module-label"
  }, "温度（随机性）")), /*#__PURE__*/React.createElement("div", {
    className: "param-slider-row"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "控制回答的发散程度：越低越严谨稳定，越高越有创意（0-2）。 命中历史问答缓存时直接返回缓存回答，本参数不生效。")), /*#__PURE__*/React.createElement("div", {
    className: "param-module"
  }, /*#__PURE__*/React.createElement("div", {
    className: "param-module-header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "param-module-icon search"
  }, /*#__PURE__*/React.createElement(Icon.Globe, {
    size: 16,
    color: "#1890FF"
  })), /*#__PURE__*/React.createElement("span", {
    className: "param-module-label"
  }, "联网搜索")), /*#__PURE__*/React.createElement("div", {
    className: "param-switch-row"
  }, /*#__PURE__*/React.createElement(Switch, {
    checked: useWebSearch,
    onChange: onSearchChange,
    disabled: loading
  }), /*#__PURE__*/React.createElement("span", {
    className: "param-switch-label"
  }, useWebSearch ? '已开启' : '已关闭')), /*#__PURE__*/React.createElement("p", {
    className: "param-hint"
  }, "默认关闭：仅检索本地知识库（问答缓存 + 离线知识库），未查到内容时返回「信息不足」； 开启后才允许联网搜索补充资料。")), /*#__PURE__*/React.createElement("div", {
    className: 'param-module' + (!useWebSearch ? ' disabled' : '')
  }, /*#__PURE__*/React.createElement("div", {
    className: "param-module-header"
  }, /*#__PURE__*/React.createElement("div", {
    className: "param-module-icon pages"
  }, /*#__PURE__*/React.createElement(Icon.FileText, {
    size: 16,
    color: PRIMARY
  })), /*#__PURE__*/React.createElement("span", {
    className: "param-module-label"
  }, "搜索网页数量")), /*#__PURE__*/React.createElement("div", {
    className: "param-slider-row"
  }, /*#__PURE__*/React.createElement("div", {
    className: "param-slider"
  }, /*#__PURE__*/React.createElement(Slider, {
    ...
    className: "param-hint"
  }, "联网搜索时抓取参考的网页数量（1-20）。数量越多资料越全、耗时越长； 仅在「联网搜索」开启时生效。"))));
}
...
function App() {
  ...
  }, [temperature, useWebSearch, webTopN]);
  useEffect(() => {
    localStorage.setItem(SK_LEFT, String(leftCollapsed));
  }, [leftCollapsed]);
  useEffect(() => {
    localStorage.setItem(SK_RIGHT, String(rightCollapsed));
  }, [rightCollapsed]);
  ...
  const saveCurrentConv = useCallback(async () => {
    ...
    setConversations(prev => prev.map(c => String(c.id) === String(id) ? {
      ...c,
      messages: msgs,
  ...
  return /*#__PURE__*/React.createElement(ConfigProvider, {
  ...
  }, "WebRAG 智能问答"), /*#__PURE__*/React.createElement("span", {
    className: "chat-topbar-sub"
  }, "检索增强生成 · 逐段引用溯源"), rightCollapsed && /*#__PURE__*/React.createElement("button", {
    ...
    className: "topbar-expand-label"
  }, "参数"))), messages.length === 0 ? /*#__PURE__*/React.createElement(EmptyGuide, {
